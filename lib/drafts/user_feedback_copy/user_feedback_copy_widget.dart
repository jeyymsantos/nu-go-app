...
class UserFeedbackCopyWidget extends StatefulWidget {
  const UserFeedbackCopyWidget({super.key});

  @override
  State<UserFeedbackCopyWidget> createState() => _UserFeedbackCopyWidgetState();
}

class _UserFeedbackCopyWidgetState extends State<UserFeedbackCopyWidget> {
  late UserFeedbackCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserFeedbackCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'user_feedbackCopy'});
                        ...
                        children: [
                          Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'USER_FEEDBACK_COPY_LottieAnimation_vc3nw');
                                logFirebaseEvent('LottieAnimation_drawer');
                                scaffoldKey.currentState!.openDrawer();
                              },
                              child: Lottie.asset(
                                'assets/jsons/Feedback.json',
                                width: 150.0,
                                height: 210.0,
                                fit: BoxFit.contain,
                                animate: true,
                                    ...
                                    Builder(
                                      builder: (context) => Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'USER_FEEDBACK_COPY_Text_ls1fr77j_ON_TAP');
                                            logFirebaseEvent(
                                                'Text_alert_dialog');
                                            await showDialog(
                                              context: context,
