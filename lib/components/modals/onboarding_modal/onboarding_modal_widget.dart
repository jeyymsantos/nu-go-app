...
import 'onboarding_modal_model.dart';
export 'onboarding_modal_model.dart';

class OnboardingModalWidget extends StatefulWidget {
  const OnboardingModalWidget({super.key});

  @override
  State<OnboardingModalWidget> createState() => _OnboardingModalWidgetState();
}

class _OnboardingModalWidgetState extends State<OnboardingModalWidget> {
  late OnboardingModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingModalModel());
