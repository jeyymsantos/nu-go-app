...
class _AuthSignInWidgetState extends State<AuthSignInWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'auth_sign_in'});
    if (!isWeb) {
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'AUTH_SIGN_IN_PAGE_Text_vfd05uku_ON_TAP');
                                                  ...
                                                  TextSpan(
                                                    ...
                                                    recognizer:
                                                        TapGestureRecognizer()
                                                          ..onTap = () async {
                                                            logFirebaseEvent(
                                                                'AUTH_SIGN_IN_RichTextSpan_e55o2yab_ON_TA');
                                                            logFirebaseEvent(
                                                  ...
                                                  TextSpan(
                                                    ...
                                                    recognizer:
                                                        TapGestureRecognizer()
                                                          ..onTap = () async {
                                                            logFirebaseEvent(
                                                                'AUTH_SIGN_IN_RichTextSpan_dudwkgu8_ON_TA');
                                                            logFirebaseEvent(
                                                                'RichTextSpan_navigate_to');
                                  ...
                                  Builder(
                                    builder: (context) => Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'AUTH_SIGN_IN_PAGE_SIGN_IN_BTN_ON_TAP');
                                                      ...
                                                      child: GestureDetector(
                                                        ...
                                                        child:
                                                          ...
                                                          infoDialogTitle:
                                                              'Account Deactivated',
                                                          infoDialogMeesage:
                                                              'Your account is deactivated. To reactivate, please email us at syn3rgy@nu-baliwag.edu.ph.',
                                                        ),
                                                      ),
                                                    ),
                                                  );
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'AUTH_SIGN_IN_PAGE_Text_ni863lvq_ON_TAP');
                                            logFirebaseEvent(
                                                'Text_navigate_to');
