...
class CartMarketplaceWidget extends StatefulWidget {
  const CartMarketplaceWidget({super.key});

  @override
  State<CartMarketplaceWidget> createState() => _CartMarketplaceWidgetState();
}

class _CartMarketplaceWidgetState extends State<CartMarketplaceWidget> {
  late CartMarketplaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartMarketplaceModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'cart_marketplace'});
                        ...
                        child: StreamBuilder<List<OrdersRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final wrapOrdersRecord =
                                wrapOrdersRecordList.isNotEmpty
                                    ? wrapOrdersRecordList.first
                                    : null;
                                                                                ...
                                                                                RichText(
                                                                                  ...
                                                                                  text: TextSpan(
                                                                                    children: [
                                                                                      ...
                                                                                      TextSpan(
                                                                                        text: cartProductsItem.quantity.toString(),
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              fontFamily: 'Montserrat',
                                                                                              letterSpacing: 0.0,
                                                                                            ),
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'CART_MARKETPLACE_Icon_kiou3sck_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_bottom_sheet');
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return WebViewAware(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                BottomSheetUpdateCartWidget(
                                                                              product: containerProductsRecord,
                                                                              quantity: cartProductsItem.quantity,
                                                                              subTotal: cartProductsItem.subTotal,
                                                                              productType: cartProductsItem,
                                                                              order: wrapOrdersRecord!,
                                                                            ),
                                                                          ),
                                                                        );
                                                                      },
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (_model
                                                                        ...
                                                                        await wrapOrdersRecord!
                                                                          ...
                                                                          ...mapToFirestore(
                                                                            {
                                                                              'total_price': FieldValue.increment(-(cartProductsItem.subTotal)),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'CART_MARKETPLACE_CONTINUE_TO_CHECKOUT_BT');
                                            logFirebaseEvent(
                                                'Button_navigate_to');
