...
class InventoryMarketplaceWidget extends StatefulWidget {
  const InventoryMarketplaceWidget({super.key});

  @override
  State<InventoryMarketplaceWidget> createState() =>
      _InventoryMarketplaceWidgetState();
}

class _InventoryMarketplaceWidgetState extends State<InventoryMarketplaceWidget>
    with TickerProviderStateMixin {
  late InventoryMarketplaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventoryMarketplaceModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'inventory_marketplace'});
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'INVENTORY_MARKETPLACE_Container_76ffnssk');
                                  logFirebaseEvent('Container_navigate_to');

                                  context.pushNamed('admin_manage_orgs');
                                },
                                child: Container(
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'INVENTORY_MARKETPLACE_Container_qg848myi');
                                  logFirebaseEvent('Container_navigate_to');

                                  context.pushNamed('admin_manage_event');
                                },
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'INVENTORY_MARKETPLACE_Container_jsixdawf');
                                  logFirebaseEvent('Container_navigate_to');
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'INVENTORY_MARKETPLACE_Container_84femdh5');
                                  logFirebaseEvent('Container_navigate_to');
                                    ...
                                    ListView(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'INVENTORY_MARKETPLACE_Container_ux1vsbjr');
                                            logFirebaseEvent(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Container(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Image
                                                                    .network(
                                                                  'https://img.lazcdn.com/g/p/mdc/dc6f40dc1118bce32be03e63248b19e2.jpg_360x360q75.jpg_.webp',
                                                                  width: 40.0,
                                                                  fit: BoxFit
                                                                      .contain,
                                                                ),
