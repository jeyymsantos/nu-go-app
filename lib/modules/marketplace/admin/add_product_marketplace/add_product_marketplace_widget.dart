...
class AddProductMarketplaceWidget extends StatefulWidget {
  const AddProductMarketplaceWidget({super.key});

  @override
  State<AddProductMarketplaceWidget> createState() =>
      _AddProductMarketplaceWidgetState();
}

class _AddProductMarketplaceWidgetState
    extends State<AddProductMarketplaceWidget> {
  late AddProductMarketplaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddProductMarketplaceModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'addProduct_marketplace'});
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'ADD_PRODUCT_MARKETPLACE_Image_wephj9yk_O');
                                      logFirebaseEvent(
                      ...
                      if (functions.convertToDouble(
                        ...
                        if (_model.confirmDialog!) {
                          ...
                          await action_blocks.logs(
                            ...
                            type: 'added',
                            module: 'product',
                            doneToName: 'to the marketplace',
                          );
                          logFirebaseEvent('Button_backend_call');

                          await ProductInventoryRecord.createDoc(
                                  _model.inventory!.reference)
                              .set({
                            ...createProductInventoryRecordData(
                              type: 'Restock',
                              quantityChange: int.tryParse(
                                  _model.quantityTextController.text),
                              previousStock: int.tryParse(
                                  _model.quantityTextController.text),
                              newStock: int.tryParse(
                                  _model.quantityTextController.text),
