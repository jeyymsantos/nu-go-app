...
import 'view_office_widget.dart' show ViewOfficeWidget;
...
class ViewOfficeModel extends FlutterFlowModel<ViewOfficeWidget> {
  ...
  List<OfficeRecord> simpleSearchResults = [];
  // Stores action output result for [Alert Dialog - Custom Dialog] action in Icon widget.
  bool? confirmOfficeDelete1;
  // Stores action output result for [Alert Dialog - Custom Dialog] action in Icon widget.
  bool? confirmDeleteOffice2;
