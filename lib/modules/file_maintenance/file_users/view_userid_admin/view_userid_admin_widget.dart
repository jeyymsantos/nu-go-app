...
class ViewUseridAdminWidget extends StatefulWidget {
  const ViewUseridAdminWidget({
    super.key,
  ...
  @override
  State<ViewUseridAdminWidget> createState() => _ViewUseridAdminWidgetState();
}

class _ViewUseridAdminWidgetState extends State<ViewUseridAdminWidget> {
  late ViewUseridAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ViewUseridAdminModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'view_userid_admin'});
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'VIEW_USERID_ADMIN_Icon_ei3jzb53_ON_TAP');
                                              logFirebaseEvent(
                                                  'Icon_navigate_back');
                                              context.pop();
                                            },
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                      image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image: Image.asset(
                                          'assets/images/NU_Student_ID_-_Front.png',
                                        ).image,
                                      ),
                                      borderRadius: BorderRadius.circular(15.0),
                                    ),
                                      ...
                                      child: Stack(
                                        children: [
                                          ClipRRect(
                                            ...
                                            child: Image.asset(
                                              'assets/images/NU_Student_ID_-_Back.png',
                                              width: 238.0,
                                              height: 407.0,
                                              fit: BoxFit.cover,
                                            ),
