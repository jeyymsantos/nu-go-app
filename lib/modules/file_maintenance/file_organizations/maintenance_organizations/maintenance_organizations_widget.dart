...
class MaintenanceOrganizationsWidget extends StatefulWidget {
  const MaintenanceOrganizationsWidget({
    super.key,
    bool? isNew,
    this.orgCode,
    this.orgName,
  ...
  final DocumentReference? orgFounder;
  final String? orgPurpose;
  final String? orgType;
  final String? orgScope;
  final DocumentReference? orgAdviser;
  final DocumentReference? orgRef;
  final String? logo;

  @override
  State<MaintenanceOrganizationsWidget> createState() =>
      _MaintenanceOrganizationsWidgetState();
}

class _MaintenanceOrganizationsWidgetState
    extends State<MaintenanceOrganizationsWidget> {
  late MaintenanceOrganizationsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MaintenanceOrganizationsModel());
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MAINTENANCE_ORGANIZATIONS_Container_kte3');
                                        logFirebaseEvent(
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.orgPurposeTextController,
                                        focusNode: _model.orgPurposeFocusNode,
                                        autofocus: true,
                                        textInputAction: TextInputAction.next,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                        ...
                                        maxLength: 100,
                                        validator: _model
                                            .orgPurposeTextControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                    Padding(
