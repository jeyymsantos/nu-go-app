...
class AdminContentCreateWidget extends StatefulWidget {
  const AdminContentCreateWidget({super.key});

  @override
  State<AdminContentCreateWidget> createState() =>
      _AdminContentCreateWidgetState();
}

class _AdminContentCreateWidgetState extends State<AdminContentCreateWidget> {
  late AdminContentCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminContentCreateModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'admin_content_create'});
    _model.contentTitleFieldTextController ??= TextEditingController();
    _model.contentTitleFieldFocusNode ??= FocusNode();

    _model.contentAuthorFieldTextController ??= TextEditingController();
    _model.contentAuthorFieldFocusNode ??= FocusNode();

    _model.contentFieldTextController ??= TextEditingController();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> adminContentCreateUsersRecordList = snapshot.data!;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'ADMIN_CONTENT_CREATE_Image_1ilkwl56_ON_T');
                                        logFirebaseEvent(
