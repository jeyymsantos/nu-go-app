...
class RscoDashboardOrigWidget extends StatefulWidget {
  const RscoDashboardOrigWidget({
    super.key,
    required this.org,
  });
  ...
  @override
  State<RscoDashboardOrigWidget> createState() =>
      _RscoDashboardOrigWidgetState();
}

class _RscoDashboardOrigWidgetState extends State<RscoDashboardOrigWidget> {
  late RscoDashboardOrigModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RscoDashboardOrigModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'rsco_dashboard_orig'});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<OrganizationsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final rscoDashboardOrigOrganizationsRecord = snapshot.data!;
                ...
                child: WebViewAware(
                  child: wrapWithModel(
                    ...
                    child: RscoSidebarWidget(
                      orgName:
                          rscoDashboardOrigOrganizationsRecord.organizationName,
                      orgType: rscoDashboardOrigOrganizationsRecord.type,
                      orgLogo: rscoDashboardOrigOrganizationsRecord.logo,
                      org: rscoDashboardOrigOrganizationsRecord,
                    ),
                  ),
                ),
              ),
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'RSCO_DASHBOARD_ORIG_Image_qznxt633_ON_TA');
                        ...
                        children: [
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  rscoDashboardOrigOrganizationsRecord
                                      .organizationName,
                                                ...
                                                children: [
                                                  Stack(
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'RSCO_DASHBOARD_ORIG_Image_5clt9ji7_ON_TA');
                                                          logFirebaseEvent(
                                                              'Image_navigate_to');
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'RSCO_DASHBOARD_ORIG_Column_8j63jlem_ON_T');
                                                        logFirebaseEvent(
                                                            'Column_navigate_to');
