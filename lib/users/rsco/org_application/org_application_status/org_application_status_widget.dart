...
class OrgApplicationStatusWidget extends StatefulWidget {
  const OrgApplicationStatusWidget({
    super.key,
  ...
  @override
  State<OrgApplicationStatusWidget> createState() =>
      _OrgApplicationStatusWidgetState();
}

class _OrgApplicationStatusWidgetState extends State<OrgApplicationStatusWidget>
    with TickerProviderStateMixin {
  late OrgApplicationStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgApplicationStatusModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'org_application_status'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<OrganizationsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final orgApplicationStatusOrganizationsRecord = snapshot.data!;
                            ...
                            Container(
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  orgApplicationStatusOrganizationsRecord.logo,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              'Your application has been reviewed and it needs revision. Click the text below to view the feedback and update your application.',
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'ORG_APPLICATION_STATUS_Text_wufxz2b0_ON_');
                                                  logFirebaseEvent(
                                                      'Text_navigate_to');
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'ORG_APPLICATION_STATUS_Row_dpw80ow3_ON_T');
                                                  logFirebaseEvent(
                                                      'Row_navigate_to');
                                                                  ...
                                                                  Flexible(
                                                                    child: StreamBuilder<
                                                                      ...
                                                                      stream:
                                                                        ...
                                                                        parent:
                                                                            orgApplicationStatusOrganizationsRecord.reference,
                                                                        queryBuilder: (applicationRecord) => applicationRecord.orderBy(
                                                                            'timestamp',
                                                                            descending:
                                                                                true),
                                                                        limit:
                                              ...
                                              if ((orgApplicationStatusOrganizationsRecord
                                                          .scope ==
                                                      'School-wide') ||
                                                  (orgApplicationStatusOrganizationsRecord
                                                          .scope ==
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ORG_APPLICATION_STATUS_Container_hke7mmw');
                                                      logFirebaseEvent(
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ORG_APPLICATION_STATUS_Container_n0w5kol');
                                                        logFirebaseEvent(
                                                            'Container_navigate_to');
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ORG_APPLICATION_STATUS_Container_5j784jy');
                                                      logFirebaseEvent(
                                                          'Container_navigate_to');
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'ORG_APPLICATION_STATUS_Container_dg4huh0');
                                                      logFirebaseEvent(
                                                          'Container_navigate_to');
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'ORG_APPLICATION_STATUS_CANCEL_APPLICATIO');
