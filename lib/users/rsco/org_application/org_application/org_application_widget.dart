...
export 'org_application_model.dart';

class OrgApplicationWidget extends StatefulWidget {
  const OrgApplicationWidget({super.key});

  @override
  State<OrgApplicationWidget> createState() => _OrgApplicationWidgetState();
}

class _OrgApplicationWidgetState extends State<OrgApplicationWidget> {
  late OrgApplicationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgApplicationModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'org_application'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> orgApplicationUsersRecordList = snapshot.data!;
              ...
              child: Form(
                ...
                child: StreamBuilder<DefaultsRecord>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final stackDefaultsRecord = snapshot.data!;
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'ORG_APPLICATION_PAGE_logo_button_ON_TAP');
                                                      logFirebaseEvent(
                                                          'logo_button_upload_media_to_firebase');
                                                      final selectedMedia =
                                                      ...
                                                      onChanged: (val) async {
                                                        safeSetState(() =>
                                                            _model.orgTypeValue =
                                                                val);
                                                        logFirebaseEvent(
                                                            'ORG_APPLICATION_org_type_ON_FORM_WIDGET_');
                                                        logFirebaseEvent(
                                                            'org_type_update_app_state');
                                                        FFAppState()
                                                                .scopeState =
                                                            valueOrDefault<
                                                                String>(
                                              ...
                                              Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    if (_model.orgTypeValue ==
                                                        'Special Interest Organization')
                                                      FlutterFlowDropDown<
                                                          String>(
                                                        controller: _model
                                                                .scopeValueController ??=
                                                            FormFieldController<
                                                                String>(
                                                          _model.scopeValue ??=
                                                              valueOrDefault<
                                                        ...
                                                        onChanged: (val) async {
                                                          safeSetState(() =>
                                                              _model.scopeValue =
                                                                  val);
                                                          logFirebaseEvent(
                                                              'ORG_APPLICATION_scope_ON_FORM_WIDGET_SEL');
                                                          logFirebaseEvent(
                                                              'scope_update_app_state');
                                                          FFAppState()
                                                                  .scopeState =
                                                              valueOrDefault<
                                                                  String>(
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    5.0),
                                                        child: Text(
                                                          'Note: Selected faculty is still subject for their approval.',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        maxLengthEnforcement:
                                                            MaxLengthEnforcement
                                                                .enforced,
                                                        validator: _model
                                                            .purposeTextControllerValidator
                                                            .asValidator(
                                                                context),
                                                      ),
                                                    ),
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          5.0),
                                                              child: Text(
                                                                'Letter of Intent & List of Officers ',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                                  ...
                                                                  if (_model.uploadedFileUrl2 !=
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'ORG_APPLICATION_Container_ulh1yc59_ON_TA');
                                                                        logFirebaseEvent(
                                                                    ...
                                                                    if (_model.uploadedFileUrl3 !=
                                                                      ...
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'ORG_APPLICATION_Container_4hpc9wzl_ON_TA');
                                                                          logFirebaseEvent(
                                                                              'Container_navigate_to');
                                                                          ...
                                                                          context
                                                                            ...
                                                                            queryParameters:
                                                                                {
                                                                              'resourceName': serializeParam(
                                                                                'Faculty Endorsement',
                                                                                ParamType.String,
                                                                              ),
                                                                              'resourceFile': serializeParam(
                                                                                _model.uploadedFileUrl3,
                                                                                ParamType.String,
                                                                              ),
                                                                            }.withoutNulls,
                                                                  ...
                                                                  if (_model.uploadedFileUrl4 !=
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'ORG_APPLICATION_Container_w2um10xu_ON_TA');
                                                                        logFirebaseEvent(
                                                                            'Container_navigate_to');
                                                                  ...
                                                                  if (_model.uploadedFileUrl5 !=
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'ORG_APPLICATION_Container_vux11jjc_ON_TA');
                                                                        logFirebaseEvent(
                                                                            'Container_navigate_to');
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.confirmDialog!) {
                                    ...
                                    logFirebaseEvent(
                                        'Button_GetOrgApprovalSet');
                                    _model.orgApprovalSet =
                                    ...
                                    await action_blocks.orgSignatorySet(
                                      context,
                                      approvalSet: _model.orgApprovalSet,
                                      adviser: _model.adviserRef,
                                      status: 'Pending',
                                      scope: FFAppState().scopeState,
                                    );
                                    ...
                                    await OrganizationsRecord.collection
                                      ...
                                      ...createOrganizationsRecordData(
                                        organizationName:
                                            _model.orgNameTextController.text,
                                        organizationNickname: '',
                                        orgAdviser:
                                            _model.adviserRef?.reference,
                                        orgFounder: currentUserReference,
                                        type: _model.orgTypeValue,
                                        scope: FFAppState().scopeState,
                                        purpose:
                                            _model.purposeTextController.text,
                                        status: 'Pending',
                                    ...
                                    await ApplicationRecord.createDoc(
                                            _model.orgOutput!.reference)
                                        .set({
                                      ...createApplicationRecordData(
                                        message:
                                            'The application has been submitted for approval.',
                                        status: 'Pending',
                                    ...
                                    await action_blocks.triggerAppNotification(
                                      context,
                                      type: 'user',
                                      title: 'Org Application Submitted',
                                      message:
                                          'Your application is now being reviewed. Please wait for updates on your org\'s profile under \'My Organizations\'.',
                                    ...
                                    await action_blocks.triggerAppNotification(
                                      context,
                                      type: 'multiple_users',
                                      title: 'New Org Application Received',
                                      message:
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child:
                                                ...
                                                congratsDialogMeesage:
                                                    'Your application for an organization is now pending for approval',
                                              ),
                                            ),
                                          ),
                                        );
                                          ...
                                          child: WebViewAware(
                                            child: GestureDetector(
                                              ...
                                              child: InformationDialogBoxWidget(
                                                ...
                                                infoDialogMeesage:
                                                    'Your application for an organization has been cancelled',
                                              ),
                                            ),
                                          ),
                                        );
