...
export 'org_revision_model.dart';

class OrgRevisionWidget extends StatefulWidget {
  const OrgRevisionWidget({
    super.key,
  ...
  @override
  State<OrgRevisionWidget> createState() => _OrgRevisionWidgetState();
}

class _OrgRevisionWidgetState extends State<OrgRevisionWidget> {
  late OrgRevisionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgRevisionModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'org_revision'});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<OrganizationsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final orgRevisionOrganizationsRecord = snapshot.data!;
                                    ...
                                    children: [
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'ORG_REVISION_PAGE_logo_button_ON_TAP');
                                                    logFirebaseEvent(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ORG_REVISION_Container_hqt8ic65_ON_TAP');
                                                                logFirebaseEvent(
                                                            ...
                                                            child: Align(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'ORG_REVISION_PAGE_Icon_qklggkj2_ON_TAP');
                                                                  logFirebaseEvent(
                                          ...
                                          if (orgRevisionOrganizationsRecord
                                                  .type !=
                                                            ...
                                                            Expanded(
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'ORG_REVISION_Container_4yfwhro4_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Container_navigate_to');
                                                            ...
                                                            Container(
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'ORG_REVISION_PAGE_Icon_xx81d7re_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Icon_upload_file_to_firebase');
                                                                  final selectedFiles =
                                                                      await selectFiles(
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ORG_REVISION_Container_mk0176sf_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_navigate_to');
                                                          ...
                                                          Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ORG_REVISION_PAGE_Icon_0731yk7v_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon_upload_file_to_firebase');
                                                                final selectedFiles =
                                                                    await selectFiles(
                                                        ...
                                                        children: [
                                                          Expanded(
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ORG_REVISION_Container_pk23lx6o_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Container_navigate_to');
                                                          ...
                                                          Container(
                                                            ...
                                                            child: InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'ORG_REVISION_PAGE_Icon_zb5wen8k_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Icon_upload_file_to_firebase');
                                                                final selectedFiles =
                                                                    await selectFiles(
                                                      ...
                                                      child: GestureDetector(
                                                        ...
                                                        child:
                                                          ...
                                                          confirmDialogMeesage:
                                                              'Are you sure you want to submit this revision?',
                                                        ),
                                                      ),
                                                    ),
                                                  );
                                                      ...
                                                      fileIntentAndOfficers:
                                                        ...
                                                        _model.uploadedFileUrl2 !=
                                                            ...
                                                            : orgRevisionOrganizationsRecord
                                                                .application
                                                                .fileIntentAndOfficers,
                                                        'https://firebasestorage.googleapis.com/v0/b/nu-go-4239c.appspot.com/o/users%2F5j4FSmo3qbapifG4iN0YMTUI7ud2%2Fuploads%2F1718690184289000.pdf?alt=media&token=29de30a3-2102-4de7-8174-f893b36b6fae',
                                                      ),
                                                        ...
                                                        child: GestureDetector(
                                                          ...
                                                          child:
                                                            ...
                                                            infoDialogTitle:
                                                                'Action Cancelled',
                                                            infoDialogMeesage:
                                                                'The action has been cancelled and no changes were made.',
                                                          ),
                                                        ),
                                                      ),
                                                    );
