...
class OrgApplicationDetailedStatusWidget extends StatefulWidget {
  const OrgApplicationDetailedStatusWidget({
    super.key,
  ...
  @override
  State<OrgApplicationDetailedStatusWidget> createState() =>
      _OrgApplicationDetailedStatusWidgetState();
}

class _OrgApplicationDetailedStatusWidgetState
    extends State<OrgApplicationDetailedStatusWidget>
    with TickerProviderStateMixin {
  late OrgApplicationDetailedStatusModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgApplicationDetailedStatusModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'org_application_detailed_status'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<OrganizationsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final orgApplicationDetailedStatusOrganizationsRecord = snapshot.data!;
                                ...
                                child: Image.network(
                                  valueOrDefault<String>(
                                    orgApplicationDetailedStatusOrganizationsRecord
                                        .logo,
                                    'https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/NU_shield.svg/800px-NU_shield.svg.png',
                                  ),
                                  fit: BoxFit.contain,
                                ),
                              ),
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  shape: BoxShape.circle,
                                                  border: Border.all(
                                                    color: (orgApplicationDetailedStatusOrganizationsRecord
                                                                    .status ==
                                                                'Cancelled') ||
                                                            (orgApplicationDetailedStatusOrganizationsRecord
                                                                    .status ==
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                return wrapWithModel(
                                                  ...
                                                  child:
                                                    ...
                                                    key: Key(
                                                      'Keyufu_${random_data.randomInteger(0, 10).toString()}',
                                                    ),
                                                    approverName:
                                                        valueOrDefault<String>(
                                                    ...
                                                    dateAndTime:
                                                        approvalStatusItem
                                                            .approvalTimestamp,
                                                    borderColor: () {
                                                      if (orgApplicationDetailedStatusOrganizationsRecord
                                                              .status ==
                                                          'Revision') {
                                                        return FlutterFlowTheme
                                                                .of(context)
                                                            .primary;
                                                      } else if ((orgApplicationDetailedStatusOrganizationsRecord
                                                                  .status ==
                                                              'Declined') ||
                                                          (orgApplicationDetailedStatusOrganizationsRecord
                                                                  .status ==
                        ...
                        StreamBuilder<List<ApplicationRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<ApplicationRecord>
                                listViewApplicationRecordList = snapshot.data!;
                                ...
                                return Padding(
                                  ...
                                  child: FutureBuilder<UsersRecord>(
                                    future: UsersRecord.getDocumentOnce(
                                        listViewApplicationRecord.schoolAdmin!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                                          ...
                                                          color: () {
                                                            if ((listViewApplicationRecord
                                                              ...
                                                              return FlutterFlowTheme
                                                                      .of(context)
                                                                  .error;
                                                            } else if (listViewApplicationRecord
                                                                    .status ==
                                                                'Approved') {
                                                              return FlutterFlowTheme
                                                                      .of(context)
                                              ...
                                              child: Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 5.0, 0.0, 10.0),
                                                child: Text(
                                                  'Your proposal has been successfully submitted and is now awaiting approval.',
                                                  textAlign: TextAlign.justify,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
