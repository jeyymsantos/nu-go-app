                                                                    ...
                                                                    children: [
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'EVENT_PROPOSAL_REVISION_start_date_ON_TA');
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          final _datePicked1Date =
                                                                            ...
                                                                            context:
                                                                                context,
                                                                            initialDate:
                                                                                functions.validateEventStartDate(),
                                                                            firstDate:
                                                                                (functions.validateEventStartDate() ?? DateTime(1900)),
                                                                            lastDate:
                                                                                DateTime(2050),
                                                                            builder:
                                                                                (context, child) {
                                                                    ...
                                                                    children: [
                                                                      InkWell(
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'EVENT_PROPOSAL_REVISION_end_date_ON_TAP');
                                                                          logFirebaseEvent(
                                                                          ...
                                                                          final _datePicked2Date =
                                                                            ...
                                                                            context:
                                                                                context,
                                                                            initialDate:
                                                                                ((_model.datePicked1 != null ? _model.datePicked1 : functions.validateEventStartDate()) ?? DateTime.now()),
                                                                            firstDate:
                                                                                ((_model.datePicked1 != null ? _model.datePicked1 : functions.validateEventStartDate()) ?? DateTime(1900)),
                                                                            lastDate:
                                                                                DateTime(2050),
                                                                            builder:
                                                                                (context, child) {
