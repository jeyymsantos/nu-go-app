...
export 'event_checked_in_model.dart';

class EventCheckedInWidget extends StatefulWidget {
  const EventCheckedInWidget({
    super.key,
    this.eventDoc,
  });
  ...
  @override
  State<EventCheckedInWidget> createState() => _EventCheckedInWidgetState();
}

class _EventCheckedInWidgetState extends State<EventCheckedInWidget> {
  late EventCheckedInModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventCheckedInModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'event_checked_in'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EVENT_CHECKED_IN_event_checked_in_ON_INI');
      logFirebaseEvent('event_checked_in_update_app_state');
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<EventAttendeesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventAttendeesRecord> eventCheckedInEventAttendeesRecordList =
            snapshot.data!;
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EVENT_CHECKED_IN_Icon_ijcz0tsg_ON_TAP');
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EVENT_CHECKED_IN_Container_vvg1b8mb_ON_T');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EVENT_CHECKED_IN_Container_n4mv1h56_ON_T');
                                      logFirebaseEvent('Container_navigate_to');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EVENT_CHECKED_IN_Container_eb5uwhew_ON_T');
                                      logFirebaseEvent('Container_navigate_to');
                                ...
                                Builder(
                                  builder: (context) {
                                    final checkedInGuests =
                                        eventCheckedInEventAttendeesRecordList
                                            .sortedList(
                                                keyOf: (e) =>
                                                    e.ticketUpdatedOn!,
                                                desc: true)
