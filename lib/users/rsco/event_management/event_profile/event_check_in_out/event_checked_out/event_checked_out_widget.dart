...
import 'event_checked_out_model.dart';
export 'event_checked_out_model.dart';

class EventCheckedOutWidget extends StatefulWidget {
  const EventCheckedOutWidget({
    super.key,
    this.eventDoc,
  });
  ...
  @override
  State<EventCheckedOutWidget> createState() => _EventCheckedOutWidgetState();
}

class _EventCheckedOutWidgetState extends State<EventCheckedOutWidget> {
  late EventCheckedOutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventCheckedOutModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'event_checked_out'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EVENT_CHECKED_OUT_event_checked_out_ON_I');
      logFirebaseEvent('event_checked_out_update_app_state');
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<EventAttendeesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventAttendeesRecord> eventCheckedOutEventAttendeesRecordList =
            snapshot.data!;
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EVENT_CHECKED_OUT_Icon_pf9i5sgy_ON_TAP');
                              ...
                              child: Row(
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EVENT_CHECKED_OUT_Container_5klrz5yb_ON_');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EVENT_CHECKED_OUT_Container_uddky0a6_ON_');
                                      logFirebaseEvent('Container_navigate_to');
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EVENT_CHECKED_OUT_Container_s1o3xwqa_ON_');
                                      logFirebaseEvent('Container_navigate_to');
                                ...
                                Builder(
                                  builder: (context) {
                                    final checkedInGuests =
                                        eventCheckedOutEventAttendeesRecordList
                                            .sortedList(
                                                keyOf: (e) =>
                                                    e.ticketUpdatedOn!,
                                                desc: true)
                                            .where((e) =>
                                                (e.ticketCheckIn != null) &&
                                                (e.ticketCheckOut != null))
                                            .toList();
                                    if (checkedInGuests.isEmpty) {
                                      return const EmptyListWidget(
                                        emptyWhat: 'check outs',
                                      );
                                    }
                                                            ...
                                                            children: [
                                                              ...
                                                              Flexible(
                                                                child: Padding(
                                                                  ...
                                                                  child: FutureBuilder<
                                                                      ProgramsRecord>(
                                                                    future: ProgramsRecord.getDocumentOnce(containerUsersRecord
                                                                        .student
                                                                        .program!),
                                                                    builder:
                                                                        (context,
                                                                      ...
                                                                      return Column(
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            ...
                                                                            )} ${checkedInGuestsItem.ticketCheckOut != null ? 'checked out.' : 'checked in.'}',
