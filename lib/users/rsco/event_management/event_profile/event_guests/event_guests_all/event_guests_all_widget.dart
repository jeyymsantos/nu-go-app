...
import 'event_guests_all_model.dart';
export 'event_guests_all_model.dart';

class EventGuestsAllWidget extends StatefulWidget {
  const EventGuestsAllWidget({
    super.key,
  ...
  @override
  State<EventGuestsAllWidget> createState() => _EventGuestsAllWidgetState();
}

class _EventGuestsAllWidgetState extends State<EventGuestsAllWidget> {
  late EventGuestsAllModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EventGuestsAllModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'event_guests_all'});
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<EventAttendeesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EventAttendeesRecord> eventGuestsAllEventAttendeesRecordList =
            snapshot.data!;
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'EVENT_GUESTS_ALL_Icon_8e15iiu1_ON_TAP');
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EVENT_GUESTS_ALL_Container_jvdydlk7_ON_T');
                                          logFirebaseEvent(
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EVENT_GUESTS_ALL_Container_0e2o1fqj_ON_T');
                                          logFirebaseEvent(
                                              'Container_navigate_to');
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EVENT_GUESTS_ALL_Container_op95mmud_ON_T');
                                          logFirebaseEvent(
                                              'Container_navigate_to');
                                            ...
                                            children: [
                                              Expanded(
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'EVENT_GUESTS_ALL_Container_xvryqt6f_ON_T');
                                                    logFirebaseEvent(
                                                        'Container_navigate_to');
                                                          ...
                                                          Column(
                                                            ...
                                                            children: [
                                                              Text(
                                                                valueOrDefault<
                                                                    String>(
                                                                  eventGuestsAllEventAttendeesRecordList
                                                                      .where((e) =>
                                                                          e.ticketStatus ==
                                                                          'Approved')
                                                                      .toList()
                                                                          ...
                                                                          Builder(
                                                                            builder: (context) =>
                                                                              ...
                                                                              child: InkWell(
                                                                                ...
                                                                                highlightColor: Colors.transparent,
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('EVENT_GUESTS_ALL_Row_004xzqvb_ON_TAP');
                                                                          ...
                                                                          Builder(
                                                                            builder: (context) =>
                                                                              ...
                                                                              child: InkWell(
                                                                                ...
                                                                                highlightColor: Colors.transparent,
                                                                                onTap: () async {
                                                                                  logFirebaseEvent('EVENT_GUESTS_ALL_Row_q95qynbu_ON_TAP');
                                                                                  var _shouldSetState = false;
                                                                                  logFirebaseEvent('Row_alert_dialog');
                                                                                  await showDialog(
                                                                                    context: context,
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          logFirebaseEvent(
                              'EVENT_GUESTS_ALL_Icon_f1wto67d_ON_TAP');
