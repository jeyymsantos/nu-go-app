...
class OrgMembersOfficersWidget extends StatefulWidget {
  const OrgMembersOfficersWidget({
    super.key,
  ...
  @override
  State<OrgMembersOfficersWidget> createState() =>
      _OrgMembersOfficersWidgetState();
}

class _OrgMembersOfficersWidgetState extends State<OrgMembersOfficersWidget>
    with TickerProviderStateMixin {
  late OrgMembersOfficersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgMembersOfficersModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'org_members_officers'});
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'ORG_MEMBERS_OFFICERS_CircleImage_20gemjw');
                                                              logFirebaseEvent(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: InkWell(
                                                          ...
                                                          onTap: () async {
                                                            logFirebaseEvent(
                                                                'ORG_MEMBERS_OFFICERS_Row_l7enm1nu_ON_TAP');
                                                            logFirebaseEvent(
                                                                'Row_bottom_sheet');
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            confirmDialogMeesage:
                                                                                'Are you sure you want to remove member? User won\'t be able to see your events but may still apply again for re-approval.',
                                                                          ),
                                                                        ),
                                                                      ),
                                                                    );
