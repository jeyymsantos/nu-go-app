...
export 'org_reports_model.dart';

class OrgReportsWidget extends StatefulWidget {
  const OrgReportsWidget({super.key});

  @override
  State<OrgReportsWidget> createState() => _OrgReportsWidgetState();
}

class _OrgReportsWidgetState extends State<OrgReportsWidget>
    with TickerProviderStateMixin {
  late OrgReportsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgReportsModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'org_reports'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProgressOrgRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProgressOrgRecord> orgReportsProgressOrgRecordList =
            snapshot.data!;
                                  ...
                                  child: Container(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: custom_widgets.SplineChart(
                                        ...
                                        height: double.infinity,
                                        title: 'Spline Data',
                                        dataSource: FFAppState().ChartData2,
                                      ),
                                    ),
                                  ),
                                ),
