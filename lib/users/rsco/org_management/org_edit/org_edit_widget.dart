...
class OrgEditWidget extends StatefulWidget {
  const OrgEditWidget({
    super.key,
  ...
  @override
  State<OrgEditWidget> createState() => _OrgEditWidgetState();
}

class _OrgEditWidgetState extends State<OrgEditWidget> {
  late OrgEditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgEditModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> orgEditUsersRecordList = snapshot.data!;
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'ORG_EDIT_PAGE_logo_button_ON_TAP');
                                                  logFirebaseEvent(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'ORG_EDIT_PAGE_Image_o47a71rl_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: ConfirmDialogBoxWidget(
                                          ...
                                          confirmDialogMeesage:
                                              'Are you sure you want to update organization? This will reflect on the organization\'s profile view.',
                                        ),
                                      ),
                                    ),
                                  );
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: CongratulationsDialogBoxWidget(
                                            ...
                                            congratsDialogMeesage:
                                                'Your organization had been updated. You may nowsee the changes on your profile view.',
                                          ),
                                        ),
                                      ),
                                    );
