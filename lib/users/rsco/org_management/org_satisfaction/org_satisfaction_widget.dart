...
class OrgSatisfactionWidget extends StatefulWidget {
  const OrgSatisfactionWidget({
    super.key,
  ...
  @override
  State<OrgSatisfactionWidget> createState() => _OrgSatisfactionWidgetState();
}

class _OrgSatisfactionWidgetState extends State<OrgSatisfactionWidget> {
  late OrgSatisfactionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgSatisfactionModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> orgSatisfactionUsersRecordList = snapshot.data!;
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  'MIDYEAR STUDENT LEADERSHIP EVALUATION (SLE) 2023-2024',
                                                ...
                                                RichText(
                                                  ...
                                                  text: TextSpan(
                                                    children: [
                                                      TextSpan(
                                                        text:
                                                            'This midyear evaluation process is an important tool for ',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
