            ...
            children: [
              Padding(
                ...
                child: RefreshIndicator(
                  ...
                  onRefresh: () async {
                    logFirebaseEvent(
                        'DASHBOARD_Column_c83sxcac_ON_PULL_TO_REF');
                    logFirebaseEvent('Column_clear_query_cache');
                    FFAppState().clearUpcomingEventsDashboardCache();
                    logFirebaseEvent('Column_clear_query_cache');
                    FFAppState().clearLatestUpdatesDashboardCache();
                  },
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'DASHBOARD_PAGE_Row_ucgk9k73_ON_TAP');
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'DASHBOARD_PAGE_Container_5u3ctr5x_ON_TAP');
                              logFirebaseEvent('Container_navigate_to');

                              context.pushNamed(
                                'event_search',
                                queryParameters: {
                                  'autofocus': serializeParam(
                                    true,
                                    ParamType.bool,
                                  ),
                                }.withoutNulls,
                            ...
                            child: StreamBuilder<DefaultsRecord>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'DASHBOARD_PAGE_Stack_0jfpf9q2_ON_TAP');
                                    ...
                                    context.pushNamed(
                                      ...
                                      queryParameters: {
                                        'pageName': serializeParam(
                                          'NU GO Research Survey',
                                          ParamType.String,
                                        ),
                                        'pageLink': serializeParam(
                                          'https://forms.gle/vqz4L1H31i6fmxfx5',
                                          ParamType.String,
                                        ),
                                      }.withoutNulls,
                                    );
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'DASHBOARD_PAGE_Text_vmhs74wm_ON_TAP');
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DASHBOARD_PAGE_Image_w3p4xjvd_ON_TAP');
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DASHBOARD_PAGE_Image_q5i7zo8l_ON_TAP');
                                      logFirebaseEvent('Image_expand_image');
                                      await Navigator.push(
                                        context,
                                        PageTransition(
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DASHBOARD_PAGE_Image_lpujeu08_ON_TAP');
                                      logFirebaseEvent('Image_expand_image');
                                      await Navigator.push(
                                        context,
                                        PageTransition(
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'DASHBOARD_PAGE_Image_vrhnhnsz_ON_TAP');
                                      logFirebaseEvent('Image_expand_image');
                                      await Navigator.push(
                                        context,
                                        PageTransition(
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'DASHBOARD_PAGE_Text_xmmxu8jc_ON_TAP');
                                        logFirebaseEvent('Text_navigate_to');
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'DASHBOARD_PAGE_Row_0qe9a1rh_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Row_navigate_to');
