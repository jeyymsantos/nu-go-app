...
class _ServicesListWidgetState extends State<ServicesListWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'services_list'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<DefaultsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final servicesListDefaultsRecord = snapshot.data!;
                                        ...
                                        children: [
                                          Expanded(
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'SERVICES_LIST_Container_uh7o2ab3_ON_TAP');
                                                logFirebaseEvent(
                                                ...
                                                context.pushNamed(
                                                  ...
                                                  queryParameters: {
                                                    ...
                                                    'pageLink': serializeParam(
                                                      'https://onlineapp.nu-baliwag.edu.ph/quest/home.php',
                                                      ParamType.String,
                                                    ),
                                                  }.withoutNulls,
                                                );
                                          ...
                                          children: [
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SERVICES_LIST_Container_gnchschq_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Container_navigate_to');
                                                  ...
                                                  context.pushNamed(
                                                    ...
                                                    queryParameters: {
                                                      ...
                                                      'pageLink':
                                                          serializeParam(
                                                        'https://onlineapp.nu-baliwag.edu.ph/projectnuis',
                                                        ParamType.String,
                                                      ),
                                                    }.withoutNulls,
                                                  );
                                          ...
                                          children: [
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'SERVICES_LIST_Container_idn6s0xn_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Container_navigate_to');
                                                  ...
                                                  context.pushNamed(
                                                    ...
                                                    queryParameters: {
                                                      ...
                                                      'pageLink':
                                                          serializeParam(
                                                        'https://onlineapp.nu-baliwag.edu.ph/bills',
                                                        ParamType.String,
                                                      ),
                                                    }.withoutNulls,
                                                  );
