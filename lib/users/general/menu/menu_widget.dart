    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await Future.wait([
        Future(() async {
          ...
          _model.programOutput = await actions.getProgramDocument(
            currentUserDocument!.student.program!.id,
          );
        }),
        Future(() async {
          logFirebaseEvent('menu_custom_action');
          _model.schoolOutput = await actions.getSchoolDocument(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent('MENU_PAGE_Row_86yvb8pa_ON_TAP');
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            AuthUserStreamWidget(
                                              builder: (context) => Text(
                                                '${valueOrDefault(currentUserDocument?.role, '')} | ${valueOrDefault(currentUserDocument?.idNumber, '')}',
