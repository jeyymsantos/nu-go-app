...
import 'org_revision_bottom_sheet_model.dart';
export 'org_revision_bottom_sheet_model.dart';

class OrgRevisionBottomSheetWidget extends StatefulWidget {
  const OrgRevisionBottomSheetWidget({
    super.key,
  ...
  @override
  State<OrgRevisionBottomSheetWidget> createState() =>
      _OrgRevisionBottomSheetWidgetState();
}

class _OrgRevisionBottomSheetWidgetState
    extends State<OrgRevisionBottomSheetWidget> {
  late OrgRevisionBottomSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrgRevisionBottomSheetModel());
                  ...
                  Builder(
                    builder: (context) => Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'ORG_REVISION_BOTTOM_SHEET_REVISION_STATU');
                          ...
                          if (_model.confirmDialogRevision!) {
                                ...
                                return Dialog(
                                  ...
                                  child: const WebViewAware(
                                    child: InformationDialogBoxWidget(
                                      ...
                                      infoDialogMeesage:
                                          'Favorable action is withheld pending the revision of the organization\'s information. The feedback will be given to the requestor and have the chance to resubmit the request.',
                                    ),
                                  ),
                                );
                              },
                            ...
                            await action_blocks.dynamicRevision(
                              ...
                              reviseOrgRef: widget.orgDoc?.reference,
                              reviseFeedback:
                                  _model.revisionMessageTextController.text,
                              reviseToWho: widget.orgDoc?.orgFounder,
                              reviseName: widget.orgDoc?.organizationName,
                            );
                          } else {
                            logFirebaseEvent('Button_alert_dialog');
                            await showDialog(
