...
class AFmoDashboardWidget extends StatefulWidget {
  const AFmoDashboardWidget({super.key});

  @override
  State<AFmoDashboardWidget> createState() => _AFmoDashboardWidgetState();
}

class _AFmoDashboardWidgetState extends State<AFmoDashboardWidget> {
  late AFmoDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AFmoDashboardModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'a_fmo_dashboard'});
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'A_FMO_DASHBOARD_Image_cc1nb8j9_ON_TAP');
                          ...
                          child: Column(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'A_FMO_DASHBOARD_PAGE_Row_e7lpw165_ON_TAP');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'A_FMO_DASHBOARD_PAGE_Row_rqix0z3k_ON_TAP');
                                  logFirebaseEvent('Row_navigate_to');
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'A_FMO_DASHBOARD_PAGE_Row_cnn89wdf_ON_TAP');
                                  logFirebaseEvent('Row_navigate_to');
