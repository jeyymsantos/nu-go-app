...
class BFormFacilityReservationWidget extends StatefulWidget {
  const BFormFacilityReservationWidget({super.key});

  @override
  State<BFormFacilityReservationWidget> createState() =>
      _BFormFacilityReservationWidgetState();
}

class _BFormFacilityReservationWidgetState
    extends State<BFormFacilityReservationWidget> {
  late BFormFacilityReservationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BFormFacilityReservationModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'b_form_facility_reservation'});
